...
public abstract class ContainerActivity extends BaseActivity implements ContainerView {
  ...
  @Override
  public void pushView(IView view, Bundle bundle) {
    if (view instanceof BaseFragment) {
      ((BaseFragment) view).setArguments(bundle);
      addFragment(((BaseFragment) view)
                      .setAnimIn(R.anim.slide_right_in)
                      .setAnimOut(R.anim.slide_right_out),
              true);
  ...
  public void ngaView(IView view) {
    if (view instanceof BaseFragment) {
      ngaAddFragment(((BaseFragment) view)
                      .setAnimIn(R.anim.slide_right_in)
                      .setAnimOut(R.anim.slide_right_out),
              true);
    }
  ...
  public void ngaAddFragment(BaseFragment fragment, boolean addToBackStack, String tag) {
    ngaAddFragment(CoreDefault.FRAGMENT_CONTAINER_ID, fragment, addToBackStack, tag);
  }
