...
public class StringUtils {
  ...
  public static SpannableString textSizeDynamic (Spanned htmlString, int textSize, int startIndex, int lastIndex) {
    SpannableString spannable = new SpannableString(htmlString);
    spannable.setSpan(new AbsoluteSizeSpan(textSize, true), startIndex, lastIndex, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    return spannable;
  }
}
